...
**문서 버전**: v1.1  
**작성일**: 2026-04-23 (2026-06-23 갱신)  
**시스템 버전**: Leadership Engine v3.0

> ⚠️ **2026-06-23 안내**: 본 문서 §3·§4의 Trait 상세 표는 일부 JSON과 불일치(stale)합니다.
> Trait/Label/이론 근거의 **단일 진실원천**은 자동 생성 카탈로그 `docs/leadership_catalog.md` 입니다.
> 변경 이력은 `docs/CHANGELOG_leadership.md`, 학술 근거는 `docs/leadership_evidence_validation_report.md`를 참조하세요.
...
│   ├── T11: Empathetic Leader           [공감형] (구 T08 Emotional Intelligence 흡수)
│   ├── T12: Balanced Leader            [균형형]
│   │     ※ T08·T10은 2026-06-24 검증으로 삭제(판별타당도 실패) — CHANGELOG v5.0
